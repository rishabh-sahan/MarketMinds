...
from marketminds.llm_clients.base_client import BaseLLMClient
from marketminds.llm_clients.model_catalog import get_known_models
...
class ModelValidationTests(unittest.TestCase):
    ...
    def test_openrouter_accepts_custom_models_without_warning(self):
