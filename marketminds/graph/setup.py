# MarketMinds/graph/setup.py

from typing import Any, Dict
from langgraph.graph import END, START, StateGraph
from langgraph.prebuilt import ToolNode

from marketminds.agents import (
...
from marketminds.agents.utils.agent_states import AgentState
...
class GraphSetup:
    ...
    def setup_graph(
        ...
        if len(selected_analysts) == 0:
            raise ValueError("MarketMinds Graph Setup Error: no analysts selected!")
