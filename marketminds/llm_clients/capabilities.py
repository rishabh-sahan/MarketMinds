...
# Sarvam's sarvam-105b family returns a null parse from
# with_structured_output (observed live: the Research Manager and Portfolio
# Manager both got None back, then fell back to free text after a wasted
# call). Declaring "none" makes bind_structured skip the structured path
# entirely, so those agents generate free text on the first attempt.
_SARVAM = ModelCapabilities(
    supports_tool_choice=False,
    supports_json_mode=False,
    supports_json_schema=False,
...
_BY_ID: dict[str, ModelCapabilities] = {
    "sarvam-105b": _SARVAM,
    "sarvam-105b-conversations": _SARVAM,
